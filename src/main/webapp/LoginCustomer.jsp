<%-- 
    ...
    Created on : Nov 3, 2023, 5:41:07 PM
    Author     : Admin
--%>
...
<html>
    ...
    <body class="container-fluid" style="padding: 6% 0;">
        <%
            Cookie[] cList = null;
        ...
        <div class="p-4 rounded center" style="width: 400px; box-shadow: 0 5px 30px 10px rgba(0, 0, 0, 0.4); margin: auto;">
            ...
            <form method="post" action="/AnimeStore/Home">
                <!--Enter the username-->
                Username: <br/>
                <input id="username" class="border border-dark rounded p-1 mb-2" type="text" name="txtUScus" style="width: 100%;"><br/>
                <small id="usernameCheck" class="text-danger"></small>
                <br/>
                <!--Enter the password-->
                Password : <br/>
                <input id="password" class="border border-dark rounded p-1" type="password" name="txtPWDcus" style="width: 100%;"><br/>
                <small id="passwordCheck" class="text-danger"></small>
                <br/>
                <!--Login button-->
                <div class="d-grid">
                    <input id="btnLoginCustomer" class="btn btn-warning mt-3 text-center text-light" type="submit" value="Login" name="btnLoginCustomer"><br/>
                </div>
            </form>
            ...
            <div class="text-center mb-2">
                <a class="btn btn-light border" href="/AnimeStore/CreateCustomer">Create New Account</a>
            </div>
