<%-- 
    ...
    Created on : Nov 8, 2023, 10:53:03 PM
    Author     : Admin
--%>
    ...
    <body>
        ...
        <main class="container" style="width: 60%;">
            ...
            <form method="post" action="/AnimeStore/ListProduct" enctype="multipart/form-data">
                ...
                <input id="quan" type="number" name="txtQuan" min="1"><br/>
                <small id="quanCheck" class="text-danger"></small><br/>

                <strong>Price:</strong><br/>
                <input id="price" type="number" name="txtPrice" min="1"><br/>
                ...
                <textarea id="des" name="txtDes"></textarea><br/>
                <small id="desCheck" class="text-danger"></small><br/>

                <input class="btn btn-danger mt-1 mb-5" type="submit" value="Add New" name="btnAddNewProduct">
            </form>
        </main>                        
