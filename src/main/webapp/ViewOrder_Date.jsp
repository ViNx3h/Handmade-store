<%-- 
    Document   : ViewOrder_Date
    Created on : Nov 7, 2023, 8:26:16 AM
    Author     : Admin
--%>
...
<html>
    <head>
        ...
        <title>View Order by Date</title>
    ...
    <body>
        ...
        <main class="container">
            <form class="mt-5 mb-5" action="/AnimeStore/ViewOrder_Date">
                <div class="d-flex">
                    <div>
                        <p>Date:</p>
                    </div>
                    <div style="padding: 0 5px">
                        <input id="date" type="date" name="date" value="<%= request.getParameter("date")%>"><br/>
                        <small id="nameCheck" class="text-danger"></small>
                    </div>
                    <div class="mb-2">
                        <input class="btn btn-light" type="submit" id="btnViewOrder_Date" name="btnViewOrder_Date" value="View Order" style=" margin: 0 5px; padding: 2px; width: 100px">
                    </div>
                    <%
            ...
            <%
                if (request.getParameter("btnViewOrder_Date") != null) {
                    ...
                    try {
                        ...
                        request.getSession().setAttribute("errorMessage", "Please choose a date!");
                        response.sendRedirect("/AnimeStore/ViewOrder_Date");
                    }
            %>
            <h5>=> Total Income in <span class="text-danger" style="font-weight: bold"><%= date%> : <%= bDAO.total_income_a_date(date)%>$</span></h5>
            <table class="container table table-bordered">
                ...
                <tbody>
                    <%
                        ResultSet rs = bDAO.getBill_byDate(date);
                        while (rs.next()) {
